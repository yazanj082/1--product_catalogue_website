<div class="row">
    <div class="col-12 col-md-10 col-lg-6 col-xl-4 mt-4">
        <form method="post" action="<?php base_url('Admin/Categories/edit'.$edit['id']);?>">
            ...
            <div class="form-group row">
                ...
                <div class="col">
                    <input type="text" name="order" class="form-control" value="<?php echo $edit['order'];?>">
                </div>
            </div>
            <div class="form-group row">
                <div class="col offset-3">
                    <div class="custom-control custom-switch">
                        <input type="checkbox" name="enabled" class="custom-control-input" id="show-on-menu" <?php echo $edit['enabled']?"checked":"";?>>
